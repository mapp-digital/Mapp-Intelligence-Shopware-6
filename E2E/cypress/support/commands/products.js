 ...
 */
Cypress.Commands.add('createProduct', (productData = {}, category) => {
    const fixture = new ProductFixture();
    return fixture.setProductFixture(productData, category);
});
...
//             //             .each( (_n, element) => {
//             //                 if(searchTerm.value === element.innerText) {createProduct
//             //                     cy.wait(1000);
