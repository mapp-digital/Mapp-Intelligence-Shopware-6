    ...
    public function getPayload(): array
    {
        ...
        return [
            ...
            [
                ...
                'displayInListing' => true,
                'name' => [
                    'de-DE' => 'Hauptprodukt ausverkauft',
                    'en-GB' => 'MappIntelligence product soldout'
                ],
                'description' => [
                    'de-DE' => self::LOREM_IPSUM,
                    'en-GB' => self::LOREM_IPSUM
            ...
            [
                ...
                'name' => [
                    'de-DE' => 'Hauptartikel',
                    'en-GB' => 'MappIntelligence product äöü'
                ],
                'description' => [
                    'de-DE' => self::LOREM_IPSUM,
                    'en-GB' => self::LOREM_IPSUM
            ...
            [
                ...
                'name' => [
                    ...
                    'en-GB' => 'MappIntelligence Variant product'
                ],
                'description' => [
                    'de-DE' => self::LOREM_IPSUM,
                    'en-GB' => self::LOREM_IPSUM
