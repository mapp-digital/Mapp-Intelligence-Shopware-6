    ...
    it('variable product: view, then switch', () => {
        ...
        cy.window()
            ...
            .then(() => {
                ...
                expect(data.contentSubcategory).to.equal('Product Detail');
                expect(data.currency).to.equal('EUR');
                expect(data.pageName).to.equal('localhost:8000/MappIntelligence-Variant-product/MappIntelligence-Variant-product-azure');
        ...
        cy.window()
            ...
            .then(() => {
                ...
                expect(data.contentSubcategory).to.equal('Product Detail');
                expect(data.currency).to.equal('EUR');
                expect(data.pageName).to.equal('localhost:8000/MappIntelligence-Variant-product/MappIntelligence-Variant-product-aliceblue');
